...
import { regionThemes, Theme } from '../../utils/region-themes';
import { Region } from '../region-selector/region-selector';
...
import { DailyDoneDialog } from '../daily-done-dialog/daily-done-dialog';
